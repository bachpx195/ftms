          ...
          <div className='modal-content'>
            ...
            <div className='modal-body'>
              ...
              <RoleFunctions functions={this.state.functions}
                page={this.state.page} updatePage={this.updatePage.bind(this)}
              />
            </div>
